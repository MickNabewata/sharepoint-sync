...
export default class SourceSection extends React.Component<SourceSectionProps, SourceSectionState> {
    ...
    /** ステートにセット */
    private setToState(state: Partial<SourceSectionState>): Promise<void> {
        return new Promise<void>((resolve: () => void) => {
            this.setState(state as SourceSectionState, () => {
                resolve();
            });
        });
    }
