...
/** 実行セクション コンポーネント */
export default class ExecuteSection extends React.Component<ExecuteSectionProps, ExecuteSectionState> {
    ...
    /** ステートにセット */
    private setToState(state: Partial<ExecuteSectionState>): Promise<void> {
        return new Promise<void>((resolve: () => void) => {
            this.setState(state as ExecuteSectionState, () => {
                resolve();
            });
        });
    }
